...
const styles = {
  ...
  div: 'p-3 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 w-full',
  form: `flex flex-col justify-center items-center p-2 rounded-md w-full max-w-3xl mx-auto text-sm lg:text-base hide-on-print`
};
