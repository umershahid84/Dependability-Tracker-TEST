                        ...
                        <tr>
                            <td align="center" style="padding: 20px;">
                              <img
                                ...
                                " />
                                <h2 style="color: #e2e2e2; margin-top: 
                                35px">Dependability Tracker</h2>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" style="padding: 20px;">
                                <h1 style="font-size: 24px; color: #e2e2e2; margin-bottom: 20px;">Create Account Credentials</h1>
                                <p style="margin-bottom: 20px;">Dear ${username},</p>
                                <p style="margin-bottom: 20px;">Click on the link below to create your login credentials:</p>
                              
                                <div style="text-align: center; margin-bottom: 20px; font-size: 12px">
                                    <a href="${createLoginCredentialsLink}?invite-id=${inviteId}&token=${inviteToken}" target="_blank" rel="noopener noreferrer" style="display: block; background-color: #4aca00; color: #ffffff; padding: 15px 25px; text-decoration: none; border-radius: 5px; font-weight: bold; font-size: 16px; width: 90%;">Create Credentials</a>
                                </div>
                            </td>
                        </tr>
                    </table>
