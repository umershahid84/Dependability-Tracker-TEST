                                ...
                                <table width="100%" border="1" cellspacing="0" cellpadding="5" style="border-collapse: collapse; margin-bottom: 20px;">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="padding: 8px 16px; border: 1px solid #4b5563; color: #e2e2e2 !important;">
                                                ${formatDate_YYYY_MM_DD_TZ(callOutDetails.callout_date, 'UTC')}
                                            ...
                                            <td style="padding: 8px 16px; border: 1px solid #4b5563; color: #e2e2e2 !important;">
                                                ${formatDate_YYYY_MM_DD_TZ(callOutDetails.shift_date, 'UTC')}${callOutDetails.shift_date_to ? ` &ndash; ${formatDate_YYYY_MM_DD_TZ(callOutDetails.shift_date_to, 'UTC')}` : ''}
                                                <div style="color: #6b7280 !important; font-size: 12px; white-space: nowrap;">
                                                    ${callOutDetails.shift_date_to ? '' : `Shift Time: ${formatTime_hh_mm_ss_TZ(callOutDetails.shift_time)}`}
                                                </div>
                                            </td>
                                            <td style="padding: 8px 16px; border: 1px solid #4b5563; color: #e2e2e2 !important;">
